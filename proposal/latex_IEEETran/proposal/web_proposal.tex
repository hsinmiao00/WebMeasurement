...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Set up the OpenWPM platform. (Hsin) 
		\begin{enumerate}
			\item Run test cases and fully test effectiveness of definitions.
		\end{enumerate}
		\item Obtain the website list from Alexa. (Nathaniel) 
		\begin{enumerate}
			\item Compile into sets of websites, broken down by country and analysis type.
		\end{enumerate}
		\item Look into Parallel Data Lab and/or set up appropriate hardware for virtual machines. (Scott)
	\end{enumerate}
	\item11/4 - 11/25:
	\begin{enumerate}
