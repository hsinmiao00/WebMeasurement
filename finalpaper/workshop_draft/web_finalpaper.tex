...
Two variables of interest are located within different SQLite tables generated by OpenWPM with each crawl: \texttt{cookies} and \texttt{http\_requests}. We extracted the domains of cookies and the URLs of HTTP requests from these two tables by using the sqlite3 library in Python.
